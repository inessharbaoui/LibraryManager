...
<body>
    <div class="dashboard-wrapper">
        <div class="top-bar">
            <div class="welcome-section">
                ...
                <div class="welcome-text">
                    ...
                    <p>Tableau de bord - Système de gestion de bibliothèque</p>
                </div>
            </div>
        ...
        <div class="main-content">
            <a href="<%= request.getContextPath() %>/LivreServlet" class="dashboard-card">
                <div class="card-icon">
                    <i class="fas fa-book"></i>
                </div>
                <div class="card-content">
                    <h3>Gestion des Livres</h3>
                    <p>Consulter, ajouter et gérer tous les livres de la bibliothèque</p>
                </div>
            ...
            <div class="dashboard-card" onclick="window.location.href='<%= request.getContextPath() %>/EtudiantServlet'">
                ...
                <div class="card-content">
                    ...
                    <p>Voir et gérer les informations des étudiants inscrits</p>
                </div>
                <i class="fas fa-arrow-right card-arrow"></i>
            </div>
            ...
            <div class="dashboard-card" onclick="window.location.href='<%= request.getContextPath() %>/EnseignantServlet'">
                ...
                <div class="card-content">
                    ...
                    <p>Accéder aux profils et informations des enseignants</p>
                </div>
                <i class="fas fa-arrow-right card-arrow"></i>
            </div>
        </div>
